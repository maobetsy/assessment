...
searchForm.addEventListener('submit', (e) => {
  ...
  dictionaryFormWrapper.style.borderRadius = '.25rem'
  dictionaryFormWrapper.style.paddingBottom = '3rem'
...
function displayError(word) {
  dictionaryFormWrapper.style.paddingBottom = '0';
  dictionaryFormWrapper.style.borderRadius = '.25rem .25rem 0 0'
